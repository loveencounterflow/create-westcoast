(async function() {
  'use strict';
  var $, CLK, Create, ExecaError, FS, GUY, PATH, Stepper, ask, cfg, copy, create, echo, execa, get_types, help, inspect, log, reverse, rpr, source_base, target_base, version, warn;
  ...
  Create = class Create extends Stepper {
    ...
    async create_app_folder() {
      ...
      while (true) {
        ...
        echo('Ω___3', "filetype:", FS.get_descriptor(this.cfg.app_base_path));
        dsc = FS.get_descriptor(this.cfg.app_base_path);
        //.....................................................................................................
        if (dsc.is_loop) {
