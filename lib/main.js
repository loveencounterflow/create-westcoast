(async function() {
  'use strict';
  var $, CLK, Create, ExecaError, FS, GUY, PATH, Stepper, ask, cfg, copy, create, echo, execa, get_filetype, get_types, inspect, log, reverse, rpr, source_base, target_base, version, warn;
